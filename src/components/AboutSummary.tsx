...
export function AboutSummary({ language }: AboutSummaryProps) {
  const content = {
    fr: {
      title: 'Le Cabinet',
      summary: "Le cabinet de Maître Alexandre Sztulman, avocat au Barreau de Paris, accompagne particuliers, entreprises, dirigeants et institutions dans des dossiers à forts enjeux, en France comme à l'échelle européenne.<br/><br/>Docteur en droit, titulaire d'un LL.M. en droit européen et enseignant à l'Université Paris 1 Panthéon-Sorbonne, Maître Alexandre Sztulman intervient principalement en droit pénal, droit européen, droit administratif, libertés fondamentales et en conseil en activités économiques, avec une expertise reconnue en sanctions internationales et européennes.<br/><br/>Fort d'une expérience acquise au sein de cabinets d'affaires internationaux, de la Cour de justice de l'Union européenne et de l'administration centrale française, le cabinet propose une approche rigoureuse, technique et stratégique, fondée sur la discrétion, l'indépendance et l'exigence juridique.<br/><br/>Installé à Paris 8ᵉ, au 22 avenue Franklin D. Roosevelt, le cabinet intervient sur l'ensemble du territoire français et en Europe, en conseil comme en contentieux, dans le strict respect des règles déontologiques de la profession d'avocat.",
